<div class="flex h-screen w-screen items-center justify-center p-5">
    <div class="w-full rounded-lg w-1/2 pb-7 ">
      <div class="flex">
        ...
        <input type="button" value="Search" class="bg-purple-500 p-2 rounded-tr-lg rounded-br-lg text-white font-semibold hover:bg-blue-800 transition-colors"/>
      </div>
    </div>
  </div>